...
export default function JobTracker() {
  ...
  const { applications, fetchApplications,addApplication,updateApplication,deleteApplication,filteredData,setFilteredData } = useJobTracker();
  ...
  const filterApplications = (status) => {
    console.log("Filtering applications with status:", status); // Debug log
    setActiveFilter(status);
    if (status === "All") {
      console.log("Setting filtered data to all applications:", applications); // Debug log
